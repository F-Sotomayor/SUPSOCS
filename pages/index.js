    ...
    <Stack width="100%" height="125vh">
      ...
      >
        <Heading width="100%" textAlign="center" marginTop={16} color="white">
          <Box>
            <Text lineHeight={1.5} fontSize={50} marginTop={24}>
              SINDICATO UNIDO DE PSICOLOGOS SOCIALES Y OPERADORES COMUNITARIOS
              DE LA SALUD MENTAL
            </Text>
          </Box>
          <Box marginTop={12}>
            <Text>
              Afiliate a nuestro sindicato y disfruta de los siguientes
              beneficios:
            </Text>
          </Box>
          <Box
    ...
    <Stack width="100%" height="90vh">
      <Flex width="100%" height="100%" padding={12}>
        ...
        <Box flex={1} display="flex" flexDirection="column">
          ...
          <Box>
            <Text>
              Somos un grupo de trabajadores de la psicologia social y otros
              ambitos relacionados con la salud mental (Operadores Socio
              Terapeuticos, Acompañantes Terapeuticos, Operadores Comunitarios,
              Sociólogos y Terapistas) que decidimos crear un sindicato con el
              fin de defender nuestros derechos laborales, propiciando
              condiciones optimas que nos permitan desarrollar nuestra labor sin
              ningun tipo de incoveniente. Tenemos como objetivo principal,
              jerarquizar nuestra profesion brindando a nuestros afiliados todo
              tipo de beneficios que sirvan para dignificarlos.
            </Text>
          </Box>
          <Box marginTop={12}>
